...
if [ ! -f $segmentationFile_labels_edit ]; then
	...
	echo "$segmentationFile_labels_edit already exists"
fi
...
if [ ! -f $segmentationFile_tissue_labels_edit ]; then
	...
	echo "$segmentationFile_tissue_labels_edit already exists"
fi
